...
class CANtoProfinet(threading.Thread):
    def __init__(self, debugOutput, updateCycle, inCANtoProfinet, outCANtoProfinet):
        threading.Thread.__init__(self)
        self.debugOutput = debugOutput
        self.updateCycle = updateCycle
        self.inCANtoProfinet = inCANtoProfinet
        self.outCANtoProfinet = outCANtoProfinet
        if self.debugOutput:
            print("CANtoProfinet: Init - Debug enabled")
        # open serial port
        if self.debugOutput:
            print("CANtoProfinet: Init - Open Serial Port")
        self.can0 = can.interface.Bus(channel = 'can0', bustype = 'socketcan', bitrate=250000)# 
    ...
    def run(self):
        ...
        while(self.running):
            ...
            try:
                ...
                qDataIn = self.inCANtoProfinet.get()
